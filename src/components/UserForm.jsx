    ...
    <>
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        <div className={styles.fieldContainer}>
          <FormField controlId="firstName" label="Etunimi" type="text" placeholder="Etunimi" feedbackText="Syötä etunimi" />
          <FormField controlId="lastName" label="Sukunimi" type="text" placeholder="Sukunimi" feedbackText="Syötä sukunimi" />
          <FormField controlId="phoneNumber" label="Puhelinnumero" type="text" placeholder="Puhelinnumero" feedbackText="Syötä puhelinnumero" />
          <FormField controlId="emailAddress" label="Sähköposti" type="email" placeholder="Sähköposti" feedbackText="Virheellinen sähköpostiosoite. Kirjoita muodossa nimi@esimerkki.com" />
