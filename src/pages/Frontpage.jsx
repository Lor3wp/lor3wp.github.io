...
const items2 = ['Täytä sähköinen varauslomake.', 'Tee varaus Sortti-aseman infossa.', 'Soita asiakaspalveluumme.']
        ...
        <div className={styles.frontImgContainer}>
          <img className={styles.frontPagePicture} src={FrontPicture} />
            <div className={styles.infoTextContainer2}>
              ...
              <p>Sortti-peräkärryn vuokrasopimus tehdään joko sähköisen varauksen yhteydessä tai Sortti-asemalla. Tarkastamme asemalla vuokraajan henkilöllisyyden.</p>
              <h2 className={styles.headingInfo3}>Vaihtoehtoiset tavat varata Sortti-peräkärry:</h2>
              <RentInfoBoxList items={items2} />
              <p>Huomioithan, että kello 17 alkavissa varauksissa peräkärry pitää noutaa Sortti-asemalta viimeistään klo 17.30.</p>
